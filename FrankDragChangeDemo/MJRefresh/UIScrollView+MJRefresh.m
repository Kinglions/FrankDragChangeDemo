...
-(MJRefreshHeader *)headerWithAnimationType:(MJRefreshAnimationType)animationType refreshingTarget:(id)target refreshingAction:(SEL)action{
    ...
    switch (animationType) {
        case MJRefreshAnimationType_Gif:{
            
            
            NSArray * idleImages = @[[UIImage imageNamed:@"adddetail"]];
            NSArray * pullingImages = @[[UIImage imageNamed:@"check.png"]];
            NSArray * refreshingImages = @[[UIImage imageNamed:@"adddetail"],[UIImage imageNamed:@"Biz电话.png"],[UIImage imageNamed:@"check.png"]];
            ...
            break;
        case MJRefreshAnimationType_Normal:{
